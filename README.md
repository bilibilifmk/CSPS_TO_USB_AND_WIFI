...
型号 | 本项目是否支持  | UPS支持性|备注
---- | ----- | ------  | ------  
光宝750W  PS-2751-7H-LF | ✅ | ❌ |输出低于3A 电流无法获取 功率无法计算 ！有UPS的不要采用这个 可能会不启动
光宝450W  | ✅ | ✅ |输出低于3A 电流无法获取 功率无法计算
华为750W EPW750-12A | ✅ | ✅ |无二号位置温度 无运行时间 风扇最低工作在3500 很吵 没有光宝系列安静 
# 序
